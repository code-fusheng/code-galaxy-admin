...
export const getRepositoryByPage = (data: Page) =>
  axios({
...
export const saveRepository = (data: any) =>
  axios({
...
export const getRepositoryById = (id: any) =>
  axios({
    url: `/${prefix_name}/getRepositoryById/${id}`,
    method: 'get'
  });

export const updateRepository = (data: any) =>
  axios({
...
export const deleteRepositoryByIds = (ids: any[]) =>
  axios({
