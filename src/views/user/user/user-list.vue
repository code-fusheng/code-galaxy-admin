    ...
    >
      ...
      <template #footer>
        <span class="dialog-footer">
          <el-button type="primary" @click="handleSaveUserRoleSubmit"
            >确 定</el-button
          >
...
import { listRole, getRoleIdsByUserId } from '@/api/user/role';
